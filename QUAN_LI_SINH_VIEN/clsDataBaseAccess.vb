...
Public Class DataBaseAccess
    ...
    Private ConnectionString As String = "Data Source=DESKTOP-PIKNVLI;Initial Catalog=quanlibenan;Integrated Security=True"

    'Purpose: Class constructor.
    Public Sub New()
        'Initialize the class' members.
        ' Set connection string of the SqlConnection object
        SqlCon = New SqlConnection With {
    ...
    System.Data.DataTable, Optional ByVal ShowErrorMessage As Boolean = False) As Boolean
        SqlDa = New SqlDataAdapter With {
            .SelectCommand = New SqlCommand(v_sSqlString, SqlCon)
        }
